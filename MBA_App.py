...
with col2:
    ...
    st.markdown("<center><img src='https://github.com/jeeva-18/streamlit_app/blob/main/Assets/Grey-Goods-under-the-Consumer-Protection-Act-e1566375131654.jpg?raw=1' width=600/></center>", unsafe_allow_html=True)
