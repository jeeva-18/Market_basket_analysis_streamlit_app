...
with col2:
    st.markdown(" <h1 >RETAIL ANALYTICS : Unveiling Consumer Behavior and Enhancing Sales through EDA,Market Basket Analysis, Customer Segmentation and Product Recommendation</h1>", unsafe_allow_html=True)
