...
with col2:
    ...
    font-size: 14px;'><i><b>Unveiling Consumer Behavior and Enhancing Sales through EDA,Market Basket Analysis, Customer Segmentation and Product Recommendation.</b></i></p>", unsafe_allow_html=True)
