...
with col2:
    ...
    st.markdown("<p style='font-size: 20px;'><i><b>Unveiling Consumer Behavior and Enhancing Sales through EDA,Market Basket Analysis, Customer Segmentation and Product Recommendation.</b></i></p>", unsafe_allow_html=True)
